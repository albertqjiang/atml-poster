...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \vspace{\shrink}
    ...
    \begin{block}{Extensions}
      ...
      \textit{Experiment summary.} To understand the significance of the temporal patterns and the gated recurrent unit, we replaced the GRU propagation model (Eq.~\eqref{eq:GRU}) with a simpler residual network structure:
